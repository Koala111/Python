...
class  Webcasestep(models.Model):
    ...
    webcasename = models.CharField('测试用例标题', max_length = 50) # 测试用例标题
    webteststep = models.CharField('测试步骤', max_length = 50) # 测试步骤
    webtestobjname = models.CharField('测试对象名称描述', max_length = 50) # 测试对象名称描述
    webfindmethod = models.CharField('定位方式', max_length = 50) # 定位方式
    webevelement = models.CharField('控件元素', max_length = 50) # 控件元素
    weboptmethod = models.CharField('操作方法', max_length = 50) # 操作方法
    webtestdate = models.CharField('测试数据', max_length = 50, null = True) # 数据 
    webassertdata = models.CharField('验证数据', max_length = 50) # 验证数据 
    webtestresult = models.BooleanField('测试结果') # 测试结果 
