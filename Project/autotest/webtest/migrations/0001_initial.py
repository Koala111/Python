...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0003_auto_20180901_2042'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webcasename', models.BooleanField(verbose_name='测试结果')),
                ('webtestresult', models.CharField(max_length=16, verbose_name='测试负责人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webtestdate', models.CharField(max_length=200, null=True, verbose_name='测试数据')),
